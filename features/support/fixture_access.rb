# Enable the fixture helper methods, such as users(:admin)
      ...
      fixtures.each do |table_name|
        ...
        define_method(table_name) do |*fixture_symbols|
          ...
          instances = fixture_symbols.map do |fixture_symbol|
            if fix = ActiveRecord::Fixtures.cached_fixtures(ActiveRecord::Base.connection, table_name).first.fixtures[fixture_symbol.to_s]
